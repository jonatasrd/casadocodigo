...
public class ProdutosControllerTest {
	...
	public void somenteAdminDeveAcessarProdutosForm() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/produtos/form")
				.with(SecurityMockMvcRequestPostProcessors.user("jonatasrd@gmail.com").password("123").roles("ADMIN")))
				.andExpect(MockMvcResultMatchers.status().is(200));
	}

	@Test
	public void diferenteDeAdminDeveSerRedirecionadoAoAcessarProdutosForm() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/produtos/form")
				.with(SecurityMockMvcRequestPostProcessors.user("jonatasrd@gmail.com").password("123").roles("USUARIO")))
